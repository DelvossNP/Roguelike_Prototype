...
def init_UI_images():
    ...
    img_mana = ImageTk.PhotoImage(Image.open("images\mana.png"))
    img_mana_bar = ImageTk.PhotoImage(Image.open("images\manabar.png"))
    return(img_hp, img_hp_bar, img_mana, img_mana_bar)

def init_UI(img_hp, img_hp_bar, img_mana, img_mana_bar, player_1, m, window):
    ...
    player_hp_label = tk.Label(highlightthickness = 0, borderwidth = 0, image = img_mana)
    player_hp_label.grid(row=2, column=m)

    player_mana_value_label = tk.Label(highlightthickness = 0, borderwidth = 0, image = img_mana_bar)
    player_mana_value_label.grid(row=2, column=m+1)
    player_mana_value_label = tk.Label(text = (str(player_1.health)), bg="blue",
    font = ("Arial", 12), height=1, width = 3, borderwidth = 0, highlightthickness = 0)
    player_mana_value_label.grid(row=2, column = m+1)
